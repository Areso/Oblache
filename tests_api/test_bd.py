...
class TestPOST:
    ...
    def test_create_back_up(self, get_token_backup):
        token, body, uuid = get_token_backup
    ...
    def test_create_back_up_with_wrong_token(self, get_token_backup):
        token, body, uuid = get_token_backup
    ...
    def test_create_back_up_with_wrong_uuid(self, get_token_backup):
        token, body, uuid = get_token_backup
    ...
    def test_create_back_up_without_wrong_uuid(self, get_token_backup):
        token, body, uuid = get_token_backup
